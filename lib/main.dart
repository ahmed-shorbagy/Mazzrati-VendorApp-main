...
import 'package:mazzraati_vendor_app/features/product/widgets/cookies_widget.dart';
...
import 'package:mazzraati_vendor_app/firebase_options.dart';
import 'package:mazzraati_vendor_app/localization/app_localization.dart';
...
import 'package:mazzraati_vendor_app/theme/dark_theme.dart';
import 'package:mazzraati_vendor_app/theme/light_theme.dart';
import 'package:mazzraati_vendor_app/utill/app_constants.dart';
import 'package:mazzraati_vendor_app/features/splash/screens/splash_screen.dart';
...
Future<void> main() async {
  ...
  saveImageFromAssets(Images.storeBanner);
  saveImageFromAssets(Images.storeImage);
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(create: (context) => di.sl<AddAuctionController>())
    ],
    child: const MyApp(),
  ));
}
...
Future<void> saveImageFromAssets(String assetPath) async {
  ...
  final String? savedPath = prefs.getString(assetPath);
  if (savedPath != null && File(savedPath).existsSync()) {
    // Image is already saved, exit the function
    return;
  }
  ...
  await prefs.setString(assetPath, filePath);
}
