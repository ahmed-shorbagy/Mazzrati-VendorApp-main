...
class ColorResources {
  ...
  static Color addProdutCardColor(BuildContext context) {
    return Provider.of<ThemeController>(context).darkTheme
        ? const Color(0xff715549)
        : const Color(0xff715549);
  }

  static Color addAuctionCardColor(BuildContext context) {
    return Provider.of<ThemeController>(context).darkTheme
        ? const Color(0xff253d4e)
        : const Color(0xff253d4e);
  }

  static Color firstTwoCardColor(BuildContext context) {
    return Provider.of<ThemeController>(context).darkTheme
        ? const Color(0xff3bb77e)
        : const Color(0xff3bb77e);
  }

  static Color lastCardColor(BuildContext context) {
    return Provider.of<ThemeController>(context).darkTheme
        ? const Color.fromARGB(255, 209, 193, 164)
        : const Color.fromARGB(255, 209, 193, 164);
  }
  ...
  static const Color floatingBtn = Color(0xff23CB60);
