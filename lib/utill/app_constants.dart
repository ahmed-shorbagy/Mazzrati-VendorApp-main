...
class AppConstants {
  ...
  static const String companyName = 'Mazzraati';
  ...
  static const String suggestedProducts =
      "/api/v3/seller/products/suggested-products";
  ...
  static void logWithColor(String message, String color) {
    print('$color$message');
  }
}
