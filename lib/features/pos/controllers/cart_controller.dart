...
import 'package:mazzraati_vendor_app/features/pos/domain/models/customer_body.dart';
import 'package:mazzraati_vendor_app/features/pos/domain/models/invoice_model.dart';
import 'package:mazzraati_vendor_app/features/pos/domain/models/place_order_body.dart';
import 'package:mazzraati_vendor_app/data/model/response/base/api_response.dart';
import 'package:mazzraati_vendor_app/features/pos/domain/models/cart_model.dart';
...
import 'package:mazzraati_vendor_app/features/pos/domain/models/temporary_cart_for_customer_model.dart';
...
import 'package:mazzraati_vendor_app/features/pos/screens/invoice_screen.dart';
import 'package:mazzraati_vendor_app/features/pos/widgets/product_variation_selection_dialog_widget.dart';
...
class CartController extends ChangeNotifier {
  ...
  void addToCart(BuildContext context, CartModel cartModel,
    ...
    if (_customerCartList[_customerIndex].cart!.any((e) =>
    ...
    } else if (_customerCartList[_customerIndex].cart!.any((e) =>
        (cartModel.varientKey != null &&
            e.product!.id == cartModel.product!.id &&
            ((e.varientKey == cartModel.varientKey))))) {
      isExistInCart(context, cartModel, decreaseQuantity: decreaseQuantity);
    } else {
      ...
      for (int i = 0; i < _customerCartList[_customerIndex].cart!.length; i++) {
        ...
        if (_customerCartList[_customerIndex].cart![i].variation != null) {
          double pAmount =
              (_customerCartList[_customerIndex].cart![i].variation!.price! *
                  quantity);
          double includeTax = 0;
          if (_customerCartList[_customerIndex].cart![i].product!.taxModel ==
              "include") {
            includeTax = calculateIncludedTax(pAmount,
                _customerCartList[_customerIndex].cart![i].product!.tax!);
          }
          _amount = _amount + (pAmount - includeTax);
        } else if (_customerCartList[_customerIndex].cart![i].varientKey !=
            null) {
          double pAmount = (_customerCartList[_customerIndex]
                  .cart![i]
                  .digitalVariationPrice! *
              quantity);
          double includeTax = 0;
          if (_customerCartList[_customerIndex].cart![i].product!.taxModel ==
              "include") {
          ...
          double pAmount =
              (_customerCartList[_customerIndex].cart![i].price! * quantity);
          double includeTax = 0;
          if (_customerCartList[_customerIndex].cart![i].product!.taxModel ==
              "include") {
            includeTax = calculateIncludedTax(pAmount,
      ...
      if (_customerCartList[_customerIndex]
        ...
        for (int i = 0;
          ...
          if (_customerCartList[_customerIndex].cart![i].variation != null) {
            ...
            if (_customerCartList[_customerIndex].cart![i].product!.taxModel ==
                "include") {
              includeTax = calculateIncludedTax(amount,
                  _customerCartList[_customerIndex].cart![i].product!.tax!);
            }
            _amount = _amount + (amount - includeTax);
          } else if (_customerCartList[_customerIndex].cart![i].varientKey !=
              null) {
            double amount = (_customerCartList[_customerIndex]
                    .cart![i]
                    .digitalVariationPrice! *
                quantity);
            double includeTax = 0;
  ...
  void removeFromCart(int index) {
    ...
    if (_customerCartList[_customerIndex].cart![index].variation != null) {
      ...
      double amount0 =
          (_customerCartList[_customerIndex].cart![index].variation!.price! *
              quantity);
      double includeTax = 0;
      if (_customerCartList[_customerIndex].cart![index].product!.taxModel ==
          "include") {
        includeTax = calculateIncludedTax(amount0,
            _customerCartList[_customerIndex].cart![index].product!.tax!);
      }
      amount = amount0 - includeTax;
    } else if (_customerCartList[_customerIndex].cart![index].varientKey !=
        null) {
      // amount = (_customerCartList[_customerIndex].cart![index].digitalVariationPrice! * quantity);
      double amount0 = (_customerCartList[_customerIndex]
              .cart![index]
              .digitalVariationPrice! *
          quantity);
      double includeTax = 0;
      ...
      double amount0 =
          (_customerCartList[_customerIndex].cart![index].price! * quantity);
      double includeTax = 0;
      if (_customerCartList[_customerIndex].cart![index].product!.taxModel ==
          "include") {
        includeTax = calculateIncludedTax(amount0,
