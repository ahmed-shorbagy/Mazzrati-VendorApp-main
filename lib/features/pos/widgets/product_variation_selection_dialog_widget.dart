          ...
          child: Consumer<ProductController>(
            builder: (ctx, productProvider, child) {
              ...
              if (variationFileType.isNotEmpty && extentions.isNotEmpty) {
                variantKey =
                    '${variationFileType[productProvider.digitalVariationIndex!]}-${extentions[productProvider.digitalVariationIndex!][productProvider.digitalVariationSubindex!]}';
                for (int i = 0;
