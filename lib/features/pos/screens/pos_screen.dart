...
import 'package:mazzraati_vendor_app/common/basewidgets/custom_header_widget.dart';
import 'package:mazzraati_vendor_app/common/basewidgets/custom_snackbar_widget.dart';
import 'package:mazzraati_vendor_app/features/pos/screens/add_new_customer_screen.dart';
import 'package:mazzraati_vendor_app/features/pos/screens/customer_search_screen.dart';
import 'package:mazzraati_vendor_app/features/pos/widgets/cart_pricing_widget.dart';
import 'package:mazzraati_vendor_app/features/pos/widgets/confirm_purchase_dialog_widget.dart';
import 'package:mazzraati_vendor_app/features/pos/widgets/coupon_apply_widget.dart';
import 'package:mazzraati_vendor_app/features/pos/widgets/extra_discount_and_coupon_dialog_widget.dart';
import 'package:mazzraati_vendor_app/features/pos/widgets/item_card_widget.dart';
import 'package:mazzraati_vendor_app/features/pos/widgets/pos_no_product_widget.dart';
            ...
            SliverToBoxAdapter(child:
              ...
              if (cartController.customerCartList.isNotEmpty) {
                ...
                for (int i = 0;
                    ...
                    i++) {
                  print(
                      "=====Tax==>>${cartController.customerCartList[cartController.customerIndex].cart![i].product!.taxModel}");
                  double? digitalVPrice = cartController
                      .customerCartList[cartController.customerIndex]
                      .cart![i]
                      .digitalVariationPrice;
                  Variation? variation = cartController
                      .customerCartList[cartController.customerIndex]
                      .cart![i]
                      .variation;
                                                                      ...
                                                                      for (int index =
                                                                        ...
                                                                        carts.add(
                                                                          ...
                                                                          cart.product!.discountType == 'flat'
                                                                              ...
                                                                              : productDiscount + ((cart.product!.discount! / 100) * (digitalVPrice ?? cart.product!.unitPrice!)),
                                                                          cart.quantity,
                                                                          cart.variant,
                                                                          cart.varientKey,
                                                                          cart.digitalVariationPrice,
