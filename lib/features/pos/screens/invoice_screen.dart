...
import 'package:mazzraati_vendor_app/features/pos/widgets/invoice_element_widget.dart';
...
import 'package:mazzraati_vendor_app/features/pos/screens/invoice_print_screen.dart';
        ...
        return SingleChildScrollView(
          child:
            ...
            if (cartController.invoice != null &&
              ...
              for (int i = 0;
                  i < cartController.invoice!.details!.length;
                  i++) {
                digitalVariation = null;
                if (cartController.invoice!.details![i].taxModel == 'include') {
                  print("======Include========>>");
                  if (cartController
                          .invoice!.details![i].productDetails?.productType ==
                      'digital') {
                    // Include  Digital
                    if (cartController.invoice!.details![i].variant != null &&
                        cartController
                            .invoice!.details![i].variant!.isNotEmpty &&
                        cartController.invoice!.details![i].productDetails
                                ?.productType ==
                            'digital') {
                      for (DigitalVariation dv in cartController.invoice!
                              .details![i].productDetails!.digitalVariation ??
                          []) {
                        if (dv.variantKey ==
                            cartController.invoice!.details![i].variant) {
                          digitalVariation = dv;
                          orderAmount = orderAmount +
                              ((digitalVariation.price! *
                                      cartController
                                          .invoice!.details![i].qty!) -
                                  cartController.invoice!.details![i].tax!);
                      ...
                      orderAmount = orderAmount +
                          ((cartController.invoice!.details![i].productDetails!
                                  .unitPrice! *
                              cartController.invoice!.details![i].qty!)) -
                          cartController.invoice!.details![i].tax!;
                      includeTax = includeTax! +
                          cartController.invoice!.details![i].tax!;
                    }
                    ...
                    // Include Physical
                    orderAmount = orderAmount +
                        ((cartController.invoice!.details![i].price! *
                            cartController.invoice!.details![i].qty!));
                    includeTax =
                        includeTax! + cartController.invoice!.details![i].tax!;
                  }
                } else {
                  //======Exclude========//
                  print("======Exclude========>>");
              ...
              print(
                  "===111===abc===>>${orderAmount - cartController.discountOnProduct}");
