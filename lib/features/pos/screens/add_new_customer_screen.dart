...
class _AddNewCustomerScreenState extends State<AddNewCustomerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<CartController>(builder: (context, customerProvider, _) {
                ...
                : CustomButtonWidget(
                    ...
                    onTap: () {
                      ...
                      if (firstName.isEmpty) {
                        ...
                        showCustomSnackBarWidget(
                            getTranslated('email_name_is_required', context),
                            context,
                            sanckBarType: SnackBarType.warning);
                        ...
                        showCustomSnackBarWidget(
                            getTranslated('city_is_required', context), context,
                            sanckBarType: SnackBarType.warning);
                      } else if (zip.isEmpty) {
                        showCustomSnackBarWidget(
                            getTranslated('zip_is_required', context), context,
                            sanckBarType: SnackBarType.warning);
