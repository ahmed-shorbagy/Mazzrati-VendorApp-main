...
import 'package:mazzraati_vendor_app/common/basewidgets/custom_date_picker_widget.dart';
import 'package:mazzraati_vendor_app/common/basewidgets/custom_drop_down_item_widget.dart';
import 'package:mazzraati_vendor_app/common/basewidgets/custom_field_with_title_widget.dart';
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                        ...
                        child:
                            Text(getTranslated('select_customer', context)!)),
                  ),
                  GestureDetector(
                ...
                return Consumer<CartController>(
                  ...
                  return Padding(
                    ...
                    child: coupon.isAdd
                        ...
                        : CustomButtonWidget(
                            btnTxt: update
                                ? getTranslated('update_coupon', context)
                                : getTranslated('submit_coupon', context),
                            onTap: () {
                              ...
                              if (couponTitle.isEmpty) {
                                ...
                                showCustomSnackBarWidget(
                                    getTranslated(
                                        'end_date_is_required', context),
                                    context,
                                    sanckBarType: SnackBarType.warning);
                              } else if (coupon.discountTypeName ==
                                      'percentage' &&
