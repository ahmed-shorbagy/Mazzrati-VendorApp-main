            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: resProvider.selectedPageIndex == 0
                    ...
                    color: resProvider.selectedPageIndex == 0
                        ...
                        : Colors.transparent),
                child: Text(
                  getTranslated(resProvider.pages[0], context)!,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                    border: Border.all(
                        color: resProvider.selectedPageIndex == 1
                            ? Theme.of(context).primaryColor
                            : Colors.transparent),
                    color: resProvider.selectedPageIndex == 1
                        ? Theme.of(context).primaryColor.withOpacity(0.15)
                        : Colors.transparent),
                child: Text(
                  getTranslated(resProvider.pages[1], context)!,
                  style: robotoRegular.copyWith(
                      color: resProvider.selectedPageIndex == 1
                          ? Theme.of(context).primaryColor
                          : Theme.of(context).hintColor),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                    border: Border.all(
                        color: resProvider.selectedPageIndex == 2
                            ? Theme.of(context).primaryColor
                            : Colors.transparent),
                    color: resProvider.selectedPageIndex == 2
                        ? Theme.of(context).primaryColor.withOpacity(0.15)
