...
class BankInfoScreen extends StatelessWidget {
  ...
  const BankInfoScreen({super.key, this.isFromMain = false});

  @override
  Widget build(BuildContext context) {
    Provider.of<BankInfoController>(context, listen: false)
        .setWarningValue(true, isUpdate: false);
    return Scaffold(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            InkWell(
                                onTap: () {
                                  bankProvider.setWarningValue(false,
                                      isUpdate: true);
                                },
                                child: SizedBox(
                                    width: 20,
