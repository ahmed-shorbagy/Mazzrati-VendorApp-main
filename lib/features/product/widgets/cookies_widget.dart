                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: int.parse(productController
                                          .stockLimitStatus?.productCount
                                          .toString() ??
                                      '0') ==
                                  1
                              ? CustomImageWidget(
                                  ...
                                  width: 35,
                                  image:
                                      '${productController.stockLimitStatus?.product?.thumbnailFullUrl?.path}')
                              : Image.asset(
                                  height: 32,
                                  width: 32,
                        ...
                        Expanded(
                          child: Column(
                              ...
                              children: [
                                Text(
                                  int.parse(productController.stockLimitStatus
                                                  ?.productCount
                                                  .toString() ??
                                              '0') ==
                                          1
                                      ? productController.stockLimitStatus
                                              ?.product?.name ??
                                          ''
                                ...
                                Text(
                                  int.parse(productController.stockLimitStatus?.productCount.toString() ?? '0') ==
                                          1
                                      ? getTranslated(
                                          'this_product_is_low', context)!
                                      : int.parse(productController
                                          ...
                                          ? (productController.stockLimitStatus!
                                                  ...
                                                  : '0') +
                                              getTranslated(
                                                  'more_products_have_low_stock',
                                                  context)!
                                          : getTranslated(
                                              'there_isnt_enough_quantity', context)!,
                        ...
                        InkWell(
                          onTap: () {
                            productController.setShowCookie(false,
                                notify: true);
                          },
                          child: Padding(
                            padding: const EdgeInsets.only(
