...
import 'package:mazzraati_vendor_app/features/product/widgets/stockout_product_card_widget.dart';

class StockOutProductView extends StatelessWidget {
  final bool isHome;
  final ScrollController? scrollController;
  const StockOutProductView(
      {super.key, required this.isHome, this.scrollController});
    ...
    return Consumer<ProductController>(
      builder: (context, prodProvider, child) {
        ...
        return Column(children: [
          ...
          prodProvider.isPaginationLoading
              ? Center(
                  child: Padding(
