...
import 'package:mazzraati_vendor_app/features/review/screens/review_reply_widget.dart';
                      ...
                      children: [
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(getTranslated('review_id', context)!,
                    ...
                    onToggle: (bool value) {
                      if (value) {
                        Provider.of<ProductReviewController>(context,
                                listen: false)
                            .reviewStatusOnOff(
                                context, reviewModel.id, 1, index,
                                fromProduct: true);
                      } else {
                        Provider.of<ProductReviewController>(context,
                                listen: false)
                            .reviewStatusOnOff(
                                context, reviewModel.id, 0, index,
                                fromProduct: true);
                      }
                    },
                  )
                    ...
                    ClipRRect(
                      ...
                      child: SizedBox(
                        ...
                        child: CustomImageWidget(
                            image:
                                "${reviewModel.customer?.imageFullUrl?.path}"),
                      ),
                    ),
                  ...
                  Expanded(
                      child: Column(
                        ...
                        reviewModel.orderId != null
                            ? Text(
                                '${getTranslated('order_id', context)!} # ${reviewModel.orderId}',
                                style: titilliumRegular.copyWith(
                                    color: Theme.of(context).hintColor))
                            : const SizedBox(),
                        const SizedBox(
                          ...
                          child: Container(
                            ...
                            child: Text(
                                reviewModel.reply != null
                                    ? getTranslated('view_reply', context)!
                                    : getTranslated('review_reply', context)!,
