...
import 'package:mazzraati_vendor_app/features/product/widgets/top_most_product_card_widget.dart';

class TopSellingProductScreen extends StatelessWidget {
  final bool isMain;
  final ScrollController? scrollController;
  const TopSellingProductScreen(
      {super.key, this.isMain = false, this.scrollController});
