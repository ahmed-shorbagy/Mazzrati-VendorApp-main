...
import 'package:mazzraati_vendor_app/features/order_details/widgets/customer_contact_widget.dart';
import 'package:mazzraati_vendor_app/features/order_details/widgets/delivery_man_information_widget.dart';
import 'package:mazzraati_vendor_app/features/order_details/widgets/order_product_list_item_widget.dart';
import 'package:mazzraati_vendor_app/features/order_details/widgets/order_setup_widget.dart';
import 'package:mazzraati_vendor_app/features/order_details/widgets/order_top_section_widget.dart';
import 'package:mazzraati_vendor_app/features/order_details/widgets/payment_status_widget.dart';
import 'package:mazzraati_vendor_app/features/order_details/widgets/shipping_and_biilling_widget.dart';
import 'package:mazzraati_vendor_app/features/order_details/widgets/third_party_delivery_info_widget.dart';

class OrderDetailsScreen extends StatefulWidget {
  final int? orderId;
  final bool fromNotification;
  const OrderDetailsScreen(
      {super.key, required this.orderId, this.fromNotification = false});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              child: Consumer<OrderController>(
                ...
                return Consumer<OrderDetailsController>(
                  ...
                  if (orderDetailsController.orderDetails != null &&
                    ...
                    shipping = orderDetailsController
                        .orderDetails![0].order!.shippingCost!;
                    ...
                    if (orderDetailsController
                            .orderDetails![0].order!.orderType ==
                        'POS') {
                      if (orderDetailsController
                  ...
                  double totalPrice =
                      subTotal + shipping - coupon - eeDiscount!;
                                                          ...
                                                          children: [
                                                            ...
                                                            orderDetailsController
                                                                ...
                                                                ? Row(
                                                                    ...
                                                                    children: [
                                                                        Text(
                                                                            getTranslated('extra_discount',
                                                                                context)!,
                                                                            style:
                                                                                titilliumRegular.copyWith(color: ColorResources.titleColor(context))),
                                                                        Text(
                                                              ...
                                                              return InkWell(
                                                                ...
                                                                child: Padding(
                                                                  padding: EdgeInsets.only(
                                                                      left: Dimensions
                                                                          .paddingSizeSmall,
                                                                      right: orderDetailsController.orderDetails![0].verificationImages!.length ==
                                                                              index +
                                                                                  1
                                                                          ? Dimensions
                                                                              .paddingSizeSmall
      ...
      bottomNavigationBar: Consumer<OrderDetailsController>(
          builder: (context, orderDetailsController, _) {
        return (orderDetailsController.orderDetails?.isNotEmpty ?? false) &&
                (orderDetailsController.orderDetails![0].order?.orderStatus ==
                    "pending")
            ? Padding(
                  ...
                  children: [
                    Expanded(
                      child: CustomButtonWidget(
                        btnTxt: getTranslated("confirmed", context),
                        onTap: () {
                    ...
                    Expanded(
                      child: CustomButtonWidget(
                        btnTxt: getTranslated("canceled", context),
