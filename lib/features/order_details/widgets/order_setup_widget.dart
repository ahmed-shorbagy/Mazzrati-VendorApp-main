...
import 'package:mazzraati_vendor_app/features/order/widgets/delivery_man_assign_widget.dart';

class OrderSetupWidget extends StatefulWidget {
  final Order? orderModel;
  final bool onlyDigital;
  const OrderSetupWidget(
      {super.key, this.orderModel, this.onlyDigital = false});
      ...
      body: SingleChildScrollView(
        child: Column(children: [
          Consumer<OrderDetailsController>(
            ...
            log(widget.orderModel!.paymentMethod.toString());
            log(orderDetailsController.orderDetails.toString());
                ...
                ? widget.orderModel!.paymentMethod == 'cash_on_delivery'
                    ? (widget.orderModel!.paymentMethod == 'cash_on_delivery' &&
                        orderDetailsController
                            ...
                            'delivered' &&
                        orderDetailsController.orderDetails![0].paymentStatus !=
                            'paid')
                    : true
                : false;
            return Column(
                ...
                inHouseShipping
                    ...
                    : CustomDropDownItemWidget(
                        ...
                        widget: DropdownButtonFormField<String>(
                          ...
                          onTap: () {
                            for (var element
                                in orderDetailsController.orderStatusList) {
                ...
                CustomDropDownItemWidget(
                  ...
                  widget: DropdownButtonFormField<String>(
                    ...
                    onChanged: !paymentActive
                        ...
                        : (value) {
                            orderDetailsController
                                .setPaymentMethodIndex(value == 'paid' ? 0 : 1);
                            orderDetailsController.updatePaymentStatus(
                                orderId: widget.orderModel!.id, status: value);
                          },
