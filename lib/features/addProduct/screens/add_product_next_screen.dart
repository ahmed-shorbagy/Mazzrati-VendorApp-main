        ...
        body: Container(
          ...
          child: Consumer<AddProductController>(
            builder: (context, resProvider, child) {
              ...
              for (int index = 0;
                  index < resProvider.selectedDigitalVariation.length;
                  index++) {
                                                          ...
                                                          child:
                                                            ...
                                                            optionsBuilder:
                                                              ...
                                                              if (value.text
                                                                ...
                                                                return colors.where((color) => colorProvider
                                                                    .colorList![
                                                                        color]
                                                                    .name!
                                                                    .toLowerCase()
                                                                ...
                                                                itemBuilder:
                                                                  ...
                                                                  return Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child: Row(
                                                                          children: [
                                                                            Consumer<SplashController>(builder: (ctx,
                                                                                colorP,
                                                                                child) {
                                                                              return Text(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            Consumer<SplashController>(builder: (ctx,
                                                                                ...
                                                                                child) {
                                                                              return Text(
                                                                                resProvider.selectedDigitalVariation[index],
                                                                                style: robotoRegular.copyWith(color: ColorResources.titleColor(context)),
                                                                              );
                                                                            }),
                                                                            const SizedBox(width: Dimensions.paddingSizeSmall),
                                                            ...
                                                            child: Column(
                                                              children: [
                                                                ...
                                                                resProvider
                                                                        ...
                                                                        .isNotEmpty
                                                                    ? SizedBox(
                                                                        height: resProvider.digitalVariationExtantion[index].isNotEmpty
                                                                            ? 40
                                                                            : 0,
                                                                        child: ListView
                                                                            .builder(
                                                                          itemCount: resProvider
                                                                              .digitalVariationExtantion[index]
                                                                              .length,
                                                                          scrollDirection:
                                                                              Axis.horizontal,
                                                                          itemBuilder:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Row(children: [
                                                                                  Consumer<SplashController>(builder: (ctx, colorP, child) {
                                                                                    return Text(
                                                                                      resProvider.digitalVariationExtantion[index][i],
                                                                                      style: robotoRegular.copyWith(color: ColorResources.titleColor(context)),
                                                                                    );
                                                                                  }),
                                                                                  const SizedBox(width: Dimensions.paddingSizeSmall),
                                                                            ...
                                                                            resProvider.digitalProductTypeIndex == 1
                                                                                ? InkWell(
                                                                                    ...
                                                                                    child: Container(
                                                                                      ...
                                                                                      child: Row(
                                                                                        mainAxisAlignment: resProvider.variationFileList[index][i].fileName == null ? MainAxisAlignment.center : MainAxisAlignment.spaceBetween,
                          ...
                          return CustomButtonWidget(
                            ...
                            onTap: () {
                              ...
                              for (int index = 0;
                                  index <
                                      resProvider
                                          .selectedDigitalVariation.length;
                                  index++) {
                                if (resProvider
                                    .digitalVariationExtantion[index].isEmpty) {
                              ...
                              for (int index = 0;
                                ...
                                for (int i = 0;
                                    i <
                                        resProvider
                                            .variationFileList[index].length;
                                    i++) {
                                  if (resProvider
                                          .variationFileList[index][i].file ==
                                      null) {
                                    isFileEmpty = true;
                                    break;
                                  }
                                ...
                                for (int i = 0;
                                    i <
                                        resProvider
                                            .variationFileList[index].length;
                                    i++) {
                                  if (resProvider.variationFileList[index][i]
                              ...
                              String orderQuantity =
                                  Provider.of<AddProductController>(context,
                                      ...
                                      .text
                                      .trim();
                              String tax = Provider.of<AddProductController>(
                                      context,
                                      listen: false)
                                  .taxController
                                  .text
                              ...
                              if (unitPrice.isEmpty) {
                                ...
                                showCustomSnackBarWidget(
                                    ...
                                    context,
                                    sanckBarType: SnackBarType.warning);
                              } else if (resProvider.productTypeIndex == 0 &&
                                  Provider.of<AddProductController>(context,
                                          listen: false)
                                      .shippingCostController
                                      .text
                                ...
                                showCustomSnackBarWidget(
                                    getTranslated(
                                        'digital_product_file_empty', context),
                                    context,
                                    sanckBarType: SnackBarType.warning);
                              } else if (!_update &&
                                  resProvider.productTypeIndex == 1 &&
                                ...
                                showCustomSnackBarWidget(
                                    getTranslated(
                                        'digital_product_price_empty', context),
                                    context,
                                    sanckBarType: SnackBarType.warning);
                              } else if (resProvider.productTypeIndex == 1 &&
                                  isSKUEmpty) {
                                showCustomSnackBarWidget(
                                    getTranslated(
                                        'digital_product_sku_empty', context),
                                    context,
                                    sanckBarType: SnackBarType.warning);
                              } else if (resProvider.productTypeIndex == 1 &&
                                  digitalProductVariationEmpty) {
                                showCustomSnackBarWidget(
                                    getTranslated(
                                        'digital_product_variation_empty',
                                        context),
                                    context,
                                    sanckBarType: SnackBarType.warning);
                              } else if ((resProvider.productTypeIndex == 1 &&
                                  ...
                                  widget.product == null &&
                                  resProvider
                                      .selectedDigitalVariation.isEmpty) {
                                showCustomSnackBarWidget(
                                    getTranslated(
                              ...
                              // }
                                ...
                                resProvider.setSelectedPageIndex(2,
                                    isUpdate: true);
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => AddProductSeoScreen(
                                      ...
                                      isFromSuggestion: widget.isFromSuggestion,
