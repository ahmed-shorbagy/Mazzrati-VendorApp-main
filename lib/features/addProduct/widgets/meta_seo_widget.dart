            ...
            children: [
              Expanded(
                ...
                children: [
                  MetaSeoItem(
                    title: 'index',
                    value: resProvider.metaSeoInfo?.metaIndex == '1'
                        ? true
                        : false,
                    callback: (bool? value) {
                      resProvider.metaSeoInfo!.metaIndex =
                          value == true ? '1' : '0';
                  ...
                  MetaSeoItem(
                    title: 'no_follow',
                    value: resProvider.metaSeoInfo?.metaNoFollow == '1'
                        ? true
                        : false,
                    callback: (bool? value) {
                      resProvider.metaSeoInfo!.metaNoFollow =
                          value == true ? '1' : '0';
                      resProvider.updateState();
                    },
                  ),
                  MetaSeoItem(
                    ...
                    value: resProvider.metaSeoInfo?.metaNoImageIndex == '1'
                        ...
                        : false,
                    callback: (bool? value) {
                      resProvider.metaSeoInfo!.metaNoImageIndex =
                          value == true ? '1' : '0';
                      resProvider.updateState();
                    },
                  ),
                ...
                children: [
                  MetaSeoItem(
                    ...
                    value: resProvider.metaSeoInfo?.metaNoArchive == '1'
                        ...
                        : false,
                    callback: (bool? value) {
                      resProvider.metaSeoInfo!.metaNoArchive =
                          value == true ? '1' : '0';
                      resProvider.updateState();
                    },
                  ),
                  MetaSeoItem(
                    ...
                    value: resProvider.metaSeoInfo?.metaNoSnippet == '1'
                        ...
                        : false,
                    callback: (bool? value) {
                      resProvider.metaSeoInfo!.metaNoSnippet =
                          value == true ? '1' : '0';
                      resProvider.updateState();
                    },
                  ),
                    ...
                    children: [
                      MetaSeoItem(
                        ...
                        value: resProvider.metaSeoInfo?.metaMaxSnippet == '1'
                            ...
                            : false,
                        callback: (bool? value) {
                          resProvider.metaSeoInfo!.metaMaxSnippet =
                              value == true ? '1' : '0';
                          resProvider.updateState();
                        },
                      ),
                      MetaSeoItem(
                        ...
                        value:
                            resProvider.metaSeoInfo?.metaMaxVideoPreview == '1'
                                ? true
                                : false,
                        callback: (bool? value) {
                          resProvider.metaSeoInfo!.metaMaxVideoPreview =
                              value == true ? '1' : '0';
                          resProvider.updateState();
                        },
                      ),
                      MetaSeoItem(
                        ...
                        value:
                            resProvider.metaSeoInfo?.metaMaxImagePreview == '1'
                                ? true
                                : false,
                        callback: (bool? value) {
                          resProvider.metaSeoInfo!.metaMaxImagePreview =
                              value == true ? '1' : '0';
                          resProvider.updateState();
                        },
                      ),
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: CustomTextFieldWidget(
                            ...
                            onChanged: (value) {
                              resProvider.metaSeoInfo
                                  ?.metaMaxVideoPreviewValue = value;
                              resProvider.updateState();
                            },
                          ),
                        ),
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: DropdownButton<String>(
                            ...
                            items: resProvider.imagePreviewType
                                .map((String value) {
