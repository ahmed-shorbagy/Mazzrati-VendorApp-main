...
class DigitalProductWidget extends StatefulWidget {
  ...
  const DigitalProductWidget(
      {super.key, this.resProvider, this.product, this.fromNextScreen = false});
                    ...
                    Container(
                      ...
                      child: DropdownButton<String>(
                        value: widget.resProvider!.productTypeIndex == 0
                            ...
                            : 'digital',
                        items:
                            <String>['physical', 'digital'].map((String value) {
                        ...
                        onChanged: (value) {
                          widget.resProvider!.setProductTypeIndex(
                              value == 'physical' ? 0 : 1, true);
                        },
                        isExpanded: true,
