...
import 'package:mazzraati_vendor_app/features/emergency_contract/domain/models/emergency_contact_model.dart';
import 'package:mazzraati_vendor_app/helper/country_code_helper.dart';
                  ...
                  child: emergencyContactProvider.isLoading
                      ...
                      : CustomButtonWidget(
                          btnTxt: widget.contactList != null
                              ? getTranslated('update_contact', context)
                              : getTranslated('add_contact', context),
                          onTap: () {
