...
import 'package:mazzraati_vendor_app/features/review/domain/models/product_review_model.dart';
...
import 'package:mazzraati_vendor_app/features/product/widgets/product_review_item_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      child: Consumer<ProductReviewController>(builder: (context, review, _) {
        ...
        return review.productReviewModel == null
                            ...
                            children: [
                              Column(
                                children: [
                                  ...
                                  RatingBarIndicatorWidget(
                                    rating: review.productReviewModel
                                                ?.averageRating !=
                                            null
                                        ? double.parse(review
                              ...
                              SingleChildScrollView(
                                ...
                                child: PaginatedListViewWidget(
                                  ...
                                  totalSize:
                                      review.productReviewModel!.totalSize,
                                  offset: review.productReviewModel != null
                                      ? int.parse(
                                          review.productReviewModel!.offset!)
                                      : null,
                                  onPaginate: (int? offset) async {
                                    await review.getProductWiseReviewList(
                                        context,
                                        offset!,
                                  ...
                                  itemView: ListView.builder(
                                      ...
                                      itemCount:
                                          review.productReviewList.length,
                                      itemBuilder: (context, index) {
                                        return ProductReviewItemWidget(
                                            reviewModel:
                                                review.productReviewList[index],
                                            index: index,
                                            productId:
                                                widget.productModel!.id!);
                                      }),
            ...
            child: ClipRRect(
              ...
              child: LinearProgressIndicator(
                ...
                valueColor: AlwaysStoppedAnimation<Color>(
                    colr ?? Theme.of(context).primaryColor.withOpacity(0.30)),
