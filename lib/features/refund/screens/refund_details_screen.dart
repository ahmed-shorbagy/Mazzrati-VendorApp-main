...
import 'package:mazzraati_vendor_app/features/refund/widgets/change_log_widget.dart';
import 'package:mazzraati_vendor_app/features/refund/widgets/refund_details_widget.dart';
...
class RefundDetailsScreen extends StatefulWidget {
  ...
  const RefundDetailsScreen(
      {super.key, this.refundModel, this.orderDetailsId, this.variation});
