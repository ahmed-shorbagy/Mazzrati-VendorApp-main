...
import 'package:mazzraati_vendor_app/features/refund/widgets/refund_attachment_list_widget.dart';
...
import 'package:mazzraati_vendor_app/features/refund/screens/refund_details_screen.dart';

class RefundWidget extends StatelessWidget {
  final RefundModel? refundModel;
  final bool isDetails;
  const RefundWidget(
      {super.key, required this.refundModel, this.isDetails = false});
                                          ...
                                          ? Container(
                                              ...
                                              child: ClipRRect(
                                                  ...
                                                  child: CustomImageWidget(
                                                    image:
                                                        '${refundModel!.product!.thumbnailFullUrl?.path}',
                                                  )),
                                            )
                                          : const SizedBox(),
                                      const SizedBox(
