...
import 'package:mazzraati_vendor_app/features/chat/domain/models/chat_model.dart';
import 'package:mazzraati_vendor_app/features/chat/domain/models/message_body.dart';
    ...
    if (apiResponse.response != null &&
      ...
      if (offset == 1) {
        ...
        for (var data in messageModel!.message!) {
          if (!_dateList.contains(DateConverter.dateStringMonthYear(
