...
import 'package:mazzraati_vendor_app/features/chat/screens/chat_screen.dart';

class ChatCardWidget extends StatelessWidget {
  final Chat? chat;
  const ChatCardWidget({super.key, this.chat});
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      (chat!.message == null && chat!.attachment != null)
