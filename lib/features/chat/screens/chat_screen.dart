...
import 'package:mazzraati_vendor_app/helper/image_size_checker.dart';
...
import 'package:mazzraati_vendor_app/features/chat/widgets/chat_shimmer_widget.dart';
import 'package:mazzraati_vendor_app/features/chat/widgets/message_bubble_widget.dart';
import 'package:mazzraati_vendor_app/features/chat/widgets/send_message_widget.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    Provider.of<ChatController>(context, listen: false)
        .setEmojiPickerValue(false, notify: false);
    super.initState();
  }
      ...
      body: Consumer<ChatController>(builder: (context, chat, child) {
        return Column(children: [
                  ...
                  ? chat.messageList!.isNotEmpty
                      ? SingleChildScrollView(
                          ...
                          child: PaginatedListViewWidget(
                            ...
                            offset: chat.messageModel != null
                                ? int.parse(chat.messageModel!.offset!)
                                : 1,
                            onPaginate: (int? offset) async => await chat
                                .getMessageList(widget.userId, offset!,
                                    reload: false),
          ...
          chat.pickedImageFileStored != null &&
              ...
              ? Container(
                  color: chat.isLoading == false &&
                          ((chat.pickedImageFileStored != null &&
                                  chat.pickedImageFileStored!.isNotEmpty) ||
                              (chat.objFile != null &&
                                  chat.objFile!.isNotEmpty))
                      ? Theme.of(context).primaryColor.withOpacity(0.1)
                      : null,
                  height: (chat.pickedFIleCrossMaxLimit ||
                          chat.pickedFIleCrossMaxLength ||
                          chat.singleFIleCrossMaxLimit)
                      ? 110
                      : 90,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (chat.pickedFIleCrossMaxLimit ||
                          chat.pickedFIleCrossMaxLength ||
                          chat.singleFIleCrossMaxLimit)
                        Text(
                          "${chat.pickedFIleCrossMaxLength ? "• ${getTranslated('can_not_select_more_than', context)!} ${AppConstants.maxLimitOfTotalFileSent.floor()} 'files' " : ""} "
          ...
          chat.objFile != null &&
              ...
              : const SizedBox(),
          SizedBox(
              height: chat.openEmojiPicker ? 360 : 60,
