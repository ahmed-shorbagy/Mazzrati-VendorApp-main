...
import 'package:mazzraati_vendor_app/features/profile/screens/profile_screen.dart';
import 'package:mazzraati_vendor_app/features/profile/widgets/theme_changer_widget.dart';
...
class InfoItem extends StatelessWidget {
  ...
  final bool isMoney;
  const InfoItem(
      {super.key, this.icon, this.title, this.amount, this.isMoney = false});
