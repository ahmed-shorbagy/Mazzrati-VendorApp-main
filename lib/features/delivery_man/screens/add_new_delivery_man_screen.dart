...
import 'package:mazzraati_vendor_app/features/delivery_man/widgets/delivery_man_info_widget.dart';
            ...
            children: [
              Padding(
                  ...
                  child: LinearPercentIndicator(
                      width: MediaQuery.of(context).size.width,
                      lineHeight: 4.0,
                      percent: deliveryManProvider.selectionTabIndex == 1
                          ? 0.5
                          : 0.9,
                ...
                child: (deliveryManProvider.selectionTabIndex == 1)
                        ...
                        onTap: () {
                          if (deliveryManProvider.firstNameController.text
                            ...
                            showCustomSnackBarWidget(
                                ...
                                context);
                          } else if (EmailChecker.isNotValid(deliveryManProvider
                    ...
                    : Row(
                        children: [
                          ...
                          Expanded(
                            child: deliveryManProvider.isLoading
                                ? const Center(
                                      ...
                                      if (deliveryManProvider.firstNameController.text.trim().isEmpty &&
                                        ...
                                        DeliveryManBody deliveryManBody = DeliveryManBody(
                                            ...
                                            identityNumber: deliveryManProvider
                                                .identityNumber.text
                                                .trim(),
                                            identityType: deliveryManProvider
                                                .identityType,
