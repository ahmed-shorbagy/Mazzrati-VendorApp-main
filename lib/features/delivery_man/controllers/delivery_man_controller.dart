...
import 'package:mazzraati_vendor_app/features/delivery_man/domain/model/collected_cash_model.dart';
import 'package:mazzraati_vendor_app/features/delivery_man/domain/model/delivery_man_body.dart';
import 'package:mazzraati_vendor_app/features/delivery_man/domain/model/delivery_man_earning_model.dart';
import 'package:mazzraati_vendor_app/features/delivery_man/domain/model/delivery_man_model.dart';
import 'package:mazzraati_vendor_app/features/delivery_man/domain/model/delivery_man_order_history_model.dart';
import 'package:mazzraati_vendor_app/features/delivery_man/domain/model/delivery_man_review_model.dart';
import 'package:mazzraati_vendor_app/features/delivery_man/domain/model/delivery_man_withdraw_detail_model.dart';
import 'package:mazzraati_vendor_app/features/delivery_man/domain/model/delivery_man_withdraw_model.dart';
import 'package:mazzraati_vendor_app/features/delivery_man/domain/model/order_history_log_model.dart';
import 'package:mazzraati_vendor_app/features/delivery_man/domain/model/delivery_man_detail_model.dart'
    as d;
...
import 'package:mazzraati_vendor_app/features/delivery_man/domain/model/top_delivery_man.dart';
...
class DeliveryManController extends ChangeNotifier {
  ...
  void logMessage(String message, String level) {
    ...
    switch (level) {
      ...
      case 'ERROR':
        ...
        break;
      default:
        colorCode = '\x1B[37m'; // White (default)
        break;
    }

    // Print the message with the color and reset the color afterward
    print('$colorCode$level: $message\x1B[0m');
  }
  ...
  Future<void> getDeliveryManList(Order? orderModel) async {
    ...
    for (var man in _topDeliveryManList ?? []) {
      logMessage(man.toJson().toString(), "INFO");
    }
    for (int index = 0; index < _deliveryManList!.length; index++) {
      _deliveryManIds.add(_deliveryManList![index].id);
    }

    logMessage(_deliveryManIds.toString(), "INFO");
