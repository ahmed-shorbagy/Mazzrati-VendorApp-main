...
class DeliveryManInfoWidget extends StatefulWidget {
  ...
  const DeliveryManInfoWidget(
      {super.key, this.isPassword = false, this.deliveryMan});
...
class _DeliveryManInfoWidgetState extends State<DeliveryManInfoWidget> {
  final String _countryDialCode = "+880";
              ...
              if (!widget.isPassword)
                Column(
                  children: [
                    ...
                    widget.deliveryMan != null &&
                            widget.deliveryMan!.identityImageFullUrl!.isNotEmpty
                        ? Padding(
                            padding: const EdgeInsets.symmetric(
                                horizontal: Dimensions.paddingSizeLarge,
                            ...
                            child: ListView.builder(
                                ...
                                itemCount: widget
                                    .deliveryMan!.identityImageFullUrl!.length,
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: CustomImageWidget(
                                          ...
                                          image:
                                              '${widget.deliveryMan!.identityImageFullUrl![index].path}',
                                        ),
                                      ),
                                    )
                                  ]);
                    ...
                    Directionality(
                      ...
                      child: Container(
                          ...
                          child: CustomTextFieldWidget(
                            ...
                            hintText:
                                '+966 ${deliveryManProvider.phoneController.text}',
                          )),
                    ),
                    Directionality(
                      textDirection: TextDirection.ltr,
                      child: Container(
                          ...
                          child: CustomPasswordTextFieldWidget(
                              ...
                              controller:
                                  deliveryManProvider.passwordController,
                              onChanged: (value) {
                    ...
                    Directionality(
                      ...
                      child: Container(
                          ...
                          child: CustomPasswordTextFieldWidget(
                              ...
                              textInputAction: TextInputAction.done,
                              focusNode:
                                  deliveryManProvider.confirmPasswordNode,
                              controller: deliveryManProvider
