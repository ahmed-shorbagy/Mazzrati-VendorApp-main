...
import 'package:mazzraati_vendor_app/common/basewidgets/order_shimmer_widget.dart';
...
import 'package:mazzraati_vendor_app/features/delivery_man/widgets/earning_card_widget.dart';

class DeliverymanEarningListViewWidget extends StatefulWidget {
  final DeliveryMan? deliveryMan;
  final ScrollController? scrollController;
  const DeliverymanEarningListViewWidget(
      {super.key, this.deliveryMan, this.scrollController});
