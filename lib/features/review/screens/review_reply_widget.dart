  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: CustomAppBarWidget(
          title: getTranslated('review_reply', context),
          isAction: true,
          isSwitch: true,
          index: widget.index,
          ...
          switchAction: (value) {
            if (value) {
              Provider.of<ProductReviewController>(context, listen: false)
                  .reviewStatusOnOff(
                      context, widget.reviewModel!.id, 1, widget.index,
                      fromProduct: widget.formProduct!);
            } else {
              Provider.of<ProductReviewController>(context, listen: false)
                  .reviewStatusOnOff(
                      context, widget.reviewModel!.id, 0, widget.index,
                      fromProduct: widget.formProduct!);
            }
          },
        ),
        body: Consumer<ProductReviewController>(builder: (context, review, _) {
          if (widget.reviewModel?.reply != null) {
            review.reviewReplyController.text =
                widget.reviewModel?.reply?.replyText ?? ' ';
          }
                ...
                child: SingleChildScrollView(
                  child: Column(
                      ...
                      children: [
                                        ...
                                        child: Container(
                                          ...
                                          child: ClipRRect(
                                              ...
                                              child: CustomImageWidget(
                                                image:
                                                    '${widget.reviewModel!.product!.thumbnailFullUrl?.path}',
                                              )),
                                        ),
                                      ),
                                      const SizedBox(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          widget.reviewModel?.orderId != null
                                              ? Text(
                                                  '${getTranslated('order_id', context)!} # ${widget.reviewModel!.orderId}',
                                                  style:
                        ...
                        (widget.reviewModel!.attachmentFullUrl != null &&
                                widget
                            ...
                            ? Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: widget
                                        .reviewModel!.attachmentFullUrl!.length,
                                    itemBuilder: (context, index) {
                                      String imageUrl =
                                          '${widget.reviewModel!.attachmentFullUrl![index].path}';
                                      return InkWell(
                                        onTap: () => showDialog(
                                          context: context,
                        ...
                        CustomTextFieldWidget(
                          ...
                          border: true,
                          hintText:
                              getTranslated('write_your_reply_here', context),
                        ),
                      ]),
                ),
              )),
                ...
                child: !review.isLoading
                    ? CustomButtonWidget(
                        ...
                        onTap: () {
                          if (review.reviewReplyController.text.isEmpty) {
                            showCustomSnackBarWidget(
                                getTranslated('write_a_review_reply', context),
                                context,
                                isError: false);
                          } else {
                            review.sendReviewReply(
                                context,
                                widget.reviewModel!.id!,
                                widget.productId!,
                                review.reviewReplyController.text,
                                widget.formProduct!);
                          }
                        ...
                        btnTxt: widget.reviewModel?.reply != null
                            ? getTranslated('update_reply', context)
